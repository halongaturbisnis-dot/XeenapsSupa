          ...
          <div className="bg-white rounded-[2rem] md:rounded-[3rem] w-full max-w-2xl shadow-2xl overflow-hidden relative flex flex-col max-h-[85vh] border border-white/20">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-5 md:p-10 space-y-6 md:space-y-8">
               ...
               <div className="p-4 md:p-6 bg-gray-50 rounded-2xl md:rounded-3xl border border-gray-100 space-y-3 md:space-y-4">
                  <div className="flex items-center gap-2 text-[8px] md:text-[10px] font-black text-[#004A74] uppercase tracking-[0.2em]">
                     <FileText className="w-3 h-3 md:w-4 md:h-4" /> Harvard Citation
                  </div>
               ...
               {detailItem.info && (
                  <div className="space-y-2 md:space-y-3">
                    <h4 className="text-[8px] md:text-[10px] font-black text-gray-400 uppercase tracking-widest flex items-center gap-2">
                      <Info className="w-3 h-3 md:w-3.5 md:h-3.5" /> Personal Remark / Abstract
                    </h4>
                    <div className="text-[11px] md:text-sm text-gray-600 leading-relaxed whitespace-pre-wrap">
                      {detailItem.info}
                    </div>
                  </div>
               )}
               ...
               <div className="flex flex-col gap-1.5 md:gap-2 pt-4 border-t border-gray-50">
                  ...
                  {detailItem.doi && (
                    <div className="flex items-center gap-2 text-[10px] md:text-xs font-bold text-gray-400">
                       <span className="text-[8px] md:text-[9px] font-black uppercase tracking-widest">DOI:</span>
                       <span className="font-mono text-[9px] md:text-[11px] text-[#004A74] opacity-70">{detailItem.doi}</span>
                    </div>
                  )}
               </div>
            </div>
            ...
            <div className="px-5 py-5 md:px-10 md:py-8 border-t border-gray-100 flex items-center justify-between gap-2 md:gap-3 bg-gray-50/30">
               ...
               <div className="flex items-center gap-2 md:gap-3">
                  ...
                  >
                    <ExternalLink className="w-3.5 h-3.5 md:w-4 md:h-4" /> <span className="hidden sm:inline">Source Link</span><span className="sm:hidden">Link</span>
                  </button>
                  {detailItem.doi && (
                    <button 
                    ...
                    >
                      <LibraryBig className="w-3.5 h-3.5 md:w-4 md:h-4" /> <span className="hidden sm:inline">Add to Library</span><span className="sm:hidden">Library</span>
                    </button>
                  )}
                  <button 
                    onClick={() => setDetailItem(null)}
                    className="px-3 py-2 md:px-8 md:py-4 bg-[#004A74] text-white rounded-xl md:rounded-2xl text-[8px] md:text-[10px] font-black uppercase tracking-widest shadow-xl shadow-[#004A74]/10 hover:scale-105 active:scale-95 transition-all"
                  >
                    Dismiss
                  </button>
               </div>
        ...
        <div className="flex items-center justify-between mb-8">
           <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-1">Stored Article References</p>
              </div>
           </div>
